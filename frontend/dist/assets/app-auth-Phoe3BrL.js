import{k as D,b as Oe,u as we,r as a,a as Fe,j as e,R as Ce}from"./vendor-react-core-B0uGejYc.js";import{c as Be,a as Te}from"./vendor-redux-GR4hUpLs.js";import{k as Le,j as Se,l as U}from"./app-core-L3PgNZOI.js";import{n as m}from"./vendor-ui-utils-CGs7t4cg.js";import{T as ce,I,B as v,F as r,d as qe,m as Y,P as Ye,g as Ue,s as C,n as de,M as xe,D as oe,R as De,C as ve}from"./vendor-antd-core-PMpIrrMR.js";import{f as Ve,i as Ee,o as Z,p as _e,q as ye,r as We,s as Je}from"./vendor-antd-icons-DK8C9GTH.js";const Ie=localStorage.getItem("token"),pe=localStorage.getItem("user");let Me=null;try{Me=pe&&pe!=="undefined"?JSON.parse(pe):null}catch(t){console.error("Failed to parse user data from localStorage",t),localStorage.removeItem("user")}const He={isAuthenticated:!!Ie,user:Me,token:Ie,loading:!1,error:null},he=Be("auth/refreshUser",async(t,{rejectWithValue:o})=>{var u,x;try{return(await Le.getProfile()).data}catch(R){return o(((x=(u=R.response)==null?void 0:u.data)==null?void 0:x.message)||"Failed to refresh user data")}}),$e=Te({name:"auth",initialState:He,reducers:{setCredentials:(t,o)=>{t.user=o.payload.user,t.token=o.payload.token,t.isAuthenticated=!0,localStorage.setItem("token",o.payload.token),localStorage.setItem("user",JSON.stringify(o.payload.user))},logout:t=>{t.user=null,t.token=null,t.isAuthenticated=!1,localStorage.removeItem("token"),localStorage.removeItem("user")}},extraReducers:t=>{t.addCase(he.pending,o=>{o.loading=!0,o.error=null}).addCase(he.fulfilled,(o,u)=>{o.loading=!1,o.user=u.payload,localStorage.setItem("user",JSON.stringify(u.payload))}).addCase(he.rejected,(o,u)=>{o.loading=!1,o.error=u.payload})}}),{setCredentials:Xe,logout:Yt}=$e.actions,Ut=$e.reducer,ke=localStorage.getItem("exhibitor_token"),Ge=localStorage.getItem("exhibitor")?JSON.parse(localStorage.getItem("exhibitor")):null,Ze={isAuthenticated:!!ke,exhibitor:Ge,token:ke,showLoginModal:!1,showForgotPasswordModal:!1,loginContext:null},Ne=Te({name:"exhibitorAuth",initialState:Ze,reducers:{setExhibitorCredentials:(t,o)=>{t.exhibitor=o.payload.exhibitor,t.token=o.payload.token,t.isAuthenticated=!0,localStorage.setItem("exhibitor_token",o.payload.token),localStorage.setItem("exhibitor",JSON.stringify(o.payload.exhibitor))},exhibitorLogout:t=>{t.exhibitor=null,t.token=null,t.isAuthenticated=!1,localStorage.removeItem("exhibitor_token"),localStorage.removeItem("exhibitor")},showLoginModal:(t,o)=>{t.showLoginModal=!0,t.showForgotPasswordModal=!1,t.loginContext=o.payload||null},hideLoginModal:t=>{t.showLoginModal=!1,t.loginContext=null},showForgotPasswordModal:t=>{t.showForgotPasswordModal=!0,t.showLoginModal=!1},hideForgotPasswordModal:t=>{t.showForgotPasswordModal=!1}}}),{setExhibitorCredentials:Dt,exhibitorLogout:Vt,showLoginModal:le,hideLoginModal:ne,showForgotPasswordModal:_t,hideForgotPasswordModal:ge}=Ne.actions,Wt=Ne.reducer,{Title:ze,Text:re,Paragraph:Ke}=ce,ae=D`
